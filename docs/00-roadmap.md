...
| Thème Dawn installé et réglé | ✅ publié le 16/08 — était resté en brouillon, la boutique tournait sur Horizon (thème par défaut) jusque-là. Bannière d'accueil, barre d'annonces (2 messages en rotation), section « Une provenance vérifiée » (texte enrichi), newsletter du pied de page traduite et page « À propos » créée (Visible), tout fait le 16/08. Reste : ajouter la page au menu de navigation, relier le bouton du bloc « Une provenance vérifiée » vers cette page. |
